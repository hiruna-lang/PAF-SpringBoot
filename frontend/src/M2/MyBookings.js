    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">Track and manage your booking requests</div>
        </div>
      ...
      <div className="workflow-bar" style={{ marginBottom: "1.25rem" }}>
        <span style={{ fontSize: ".78rem", fontWeight: 600, color: "#64748b", marginRight: ".25rem" }}>Workflow:</span>
        ...
        <span className="workflow-arrow" style={{ marginLeft: ".25rem" }}>or</span>
        <div className="workflow-step" style={{ color: "#991b1b" }}>
          <div className="workflow-dot" style={{ background: "#fecaca", color: "#991b1b" }}>✕</div>
          REJECTED
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <div className="empty-sub">Go to Resources to make your first booking</div>
        </div>
      ) : (
                  ...
                  <tr key={b.id}>
                    ...
                    <td>
                      <div className="td-resource">
                        ...
                        <br />
                        <small>{b.resourceType?.replace("_", " ")} {b.resourceLocation ? `· ${b.resourceLocation}` : ""}</small>
                      </div>
                    </td>
                    ...
                    <td style={{ fontSize: ".8rem", color: "#64748b", maxWidth: 160 }}>
                      {b.adminReason || <span style={{ color: "#cbd5e1" }}>—</span>}
                    </td>
                    <td>
                      <div className="td-actions">
                        <button className="btn btn-ghost btn-xs" onClick={() => setDetailModal(b)}>View</button>
                        {(b.status === "APPROVED" || b.status === "PENDING") && (
                          <button className="btn btn-danger btn-xs" onClick={() => { setCancelModal(b); setCancelReason(""); }}>
                            Cancel
                          </button>
                        )}
                      </div>
        ...
        <div className="modal-overlay" onClick={() => setDetailModal(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div className="modal-title">Booking Details #{detailModal.id}</div>
            ...
            <div className="booking-detail-grid">
              ...
              <div className="detail-row"><div className="detail-label">Type</div><div className="detail-value">{detailModal.resourceType?.replace("_"," ")}</div></div>
            ...
            <div className="modal-footer">
              ...
              {(detailModal.status === "APPROVED" || detailModal.status === "PENDING") && (
                <button className="btn btn-danger" onClick={() => { setDetailModal(null); setCancelModal(detailModal); setCancelReason(""); }}>
                  Cancel Booking
                </button>
              )}
            </div>
          ...
          <div className="modal">
            ...
            <div className="resource-preview">
              ...
              <span style={{ color: "#64748b", fontSize: ".85rem" }}>
                {cancelModal.bookingDate} · {cancelModal.startTime}–{cancelModal.endTime}
              </span>
            </div>
